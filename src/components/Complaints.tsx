    ...
    <div className="flex flex-col md:flex-row dark:text-white justify-between dark:bg-black font-sans gap-4 md:gap-0">
      <div className="flex flex-col justify-center p-2 md:p-6 m-2 md:m-4">
        ...
        <div className="pl-0 md:pl-4 md:ml-4 p-2 m-2 text-sm md:text-base">
          Help us improve Fixify — share your
          <br /> complaint so we can serve you better.
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-3">
              <button
                type="submit"
                disabled={loading}
                className="bg-white border rounded-2xl border-[#231212] dark:bg-[#231212] hover:text-white dark:text-white hover:bg-[#422727] dark:hover:bg-gray-800 text-black p-2 px-4 rounded w-full md:w-auto text-sm disabled:opacity-50"
              >
