      ...
      <div className="flex justify-between items-center bg-[#231212] dark:bg-black text-white p-6 shadow-md">
        ...
        <div>
          <button
            onClick={() =>
              navigate("/checkout", {
                state: { serviceName: "Refrigerator Repair", amount: amount },
              })
            }
      ...
      <div className="flex p-4">
        <div className="p-4 m-4">
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            ...
            <div>Refrigerator inspection</div>
          </div>
          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Cooling system check</div>
          </div>
          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Thermostat repair</div>
          </div>
          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Door seal replacement</div>
          </div>
          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Compressor testing</div>
          </div>
          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
        ...
        <div className="p-4 m-4">
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            ...
            <div>Compressor replacement</div>
          </div>
          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Major part replacement</div>
          </div>
          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Rewiring</div>
